...
Eric Butler's purpose with the release of \emph{Firesheep} was to warn users that the many of the websites they use heavily are very insecure. This goal will be analyzed to determine if it matches up with section 1.04 of the SE code. It states:
