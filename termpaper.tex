...
The "Judgment Principle" from the SE code acts as a guideline to which professionals in the computing field can look to in order to best make decisions regarding software. It should provide some insight into whether Butler's judgment to release \emph{Firesheep} was ethical or not.
...
So, when Butler was writing \emph{Firesheep}, he was engaged in a very technical process. Furthermore, the act of releasing the tool involved the judgment as to whether or not he should submit it to Mozilla's online add-on repository. Because of this, the phrase \textbf{decision to release Firesheep} will be substituted for the term \textbf{technical judgment} from SE Code 4.01.
...
\textbf{Update (11-27):} Butler replied to my email and is interesting in reading this paper. I will be sending him a copy of the final draft.
