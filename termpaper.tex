...
The "Judgment Principle" from the SE code acts as a guideline to which professionals in the computing field can look to in order to best make decisions regarding software. It should provide some insight into whether Butler acted ethically or not in providing \emph{Firesheep} to the public.
